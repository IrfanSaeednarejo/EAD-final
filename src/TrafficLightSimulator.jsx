    ...
    <>
          ...
          <div className=" items-center justify-center w-screen h-screen bg-gray-800 text-white">
           ...
           <div className="flex  flex-col items-center w-1/4 justify-center space-y-4 bg-gray-700 p-8 rounded-lg shadow-lg mt-8">
            <div className={`bg-red-500 w-16 h-16 rounded-full transition-colors duration-500`}></div>
            <div className={`bg-yellow-500 w-16 h-16 rounded-full transition-colors duration-500`}></div>
            <div className={`bg-green-500 w-16 h-16 rounded-full transition-colors duration-500`}></div>
           </div>
